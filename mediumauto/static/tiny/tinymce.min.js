!(function (q) {
  ...
  var tt,
    ...
    at = {
      fromHtml: function (e, t) {
        ...
        if (((n.innerHTML = e), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (
            (q.console.error("HTML does not have a single root node", e),
    ...
    Mt =
      (q.Node.ATTRIBUTE_NODE,
      q.Node.CDATA_SECTION_NODE,
      q.Node.COMMENT_NODE,
      q.Node.DOCUMENT_NODE),
    Rt =
      (q.Node.DOCUMENT_TYPE_NODE,
      q.Node.DOCUMENT_FRAGMENT_NODE,
      q.Node.ELEMENT_NODE),
    Dt = q.Node.TEXT_NODE,
    _t =
      (q.Node.PROCESSING_INSTRUCTION_NODE,
    ...
    Lt =
      ("undefined" != typeof q.window ? q.window : Function("return this;")(),
      Be(Rt)),
    Vt = Be(Dt),
    It = function (n, r) {
      return {
  ...
  var ln,
    ...
    xn = window.Promise
      ...
      : ((ln =
        ...
        (fn =
          En.immediateFn ||
          ("function" == typeof q.setImmediate && q.setImmediate) ||
          function (e) {
            q.setTimeout(e, 1);
          }),
  ...
  var Ln = {
    ...
    $n =
      "FormData" in q.window &&
      "FileReader" in q.window &&
      "URL" in q.window &&
    ...
    Jn = {
      ...
      createNS: function (e, t) {
        var n, r;
        for (t = t || q.window, e = e.split("."), n = 0; n < e.length; n++)
          t[(r = e[n])] || (t[r] = {}), (t = t[r]);
        return t;
      },
      resolve: function (e, t) {
        var n, r;
        for (
          t = t || q.window, n = 0, r = (e = e.split(".")).length;
          n < r && (t = t[e[n]]);
          n++
        );
        return t;
  ...
  function Ur(e, t) {
    ...
    if (
      (r.target || (r.target = r.srcElement || q.document),
  ...
  function Qi(a, u) {
    ...
    var A = {},
            ...
            if (2 !== l.status)
              if (3 !== l.status) {
                if (
                  ...
                  "onload" in u &&
                    !(
                      (h = q.navigator.userAgent.match(/WebKit\/(\d*)/)) &&
                      parseInt(h[1], 10) < 536
                    ))
                )
      ...
      I = function (e, t, n, r) {
        ...
        return (
          !u.collect || (e !== a && e !== M) || D.push([e, t, n, r]),
          H.bind(e, t, n, r || U)
        );
      },
      F = function (e, t, n) {
      ...
      (ia.prototype.loadScript = function (e, t, n) {
        ...
        (o = i.uniqueId()),
          ...
          (r.onerror = function () {
            P(n)
              ? n()
              : "undefined" != typeof q.console &&
                q.console.log &&
                q.console.log("Failed to load script: " + e);
          }),
          (
            q.document.getElementsByTagName("head")[0] || q.document.body
          ).appendChild(r);
      }),
  ...
  function jf(e, t) {
    e.focusedEditor === t.editor && (e.focusedEditor = null),
      e.activeEditor || (Rd.unbind(q.document, "focusin", fd), (fd = null));
  }
  function qf(t, e) {
    return (function (e) {
      return e.collapsed
  ...
  function Zf(t, n, r) {
    return (
      ...
      (r.set = !0),
      (r.content = Yf(n) ? "" : n),
      Yf(n) || r.no_events || (t.fire("BeforeSetContent", r), (n = r.content)),
              ...
              return (
                0 === n.length || /^\s+$/.test(n)
                  ? ((i = '<br data-mce-bogus="1">'),
                    ...
                    e.fire("SetContent", r))
                  : ("raw" !== r.format &&
                      (n = Ef({ validate: e.validate }, e.schema).serialize(
      ...
      e.removed ||
        (t
          ...
          : (function (t) {
              ...
              t.inline || (Kn.opera || Wf(n), t.getWin().focus()),
                (Kn.gecko || t.inline) && (Wf(n), $f(t, r)),
                Hd(t);
            })(e));
    },
    Pd = Xf,
    ...
    var n,
      ...
      m = function (e, t) {
        ...
        if (
          (function (e) {
            return (
              !!e && (!!Um(e) || (jm(e.startContainer) && jm(e.endContainer)))
            );
          })(e)
        ) {
          var o = Um(e) ? e : null;
          ...
          return (function (e, t) {
            ...
            return t
              ? ((r = t.startContainer),
                ...
                3 === r.nodeType &&
                  3 === o.nodeType &&
                  ((r = r.length === i ? fm(r.nextSibling, !0) : r.parentNode),
  ...
  function Km(e, t, n, r) {
    (e.padd_empty_with_br || t.insert) && n[r.name]
      ? (r.empty().append(new pf("br", 1)).shortEnded = !0)
      : (r.empty().append(new pf("#text", 3)).value = $r);
  }
  function Xm(t, e, n, r) {
      ...
      e = {
        ...
        parse: function (e, a) {
          ...
          (a = a || {}),
            ...
            (_ = {}),
            (l = ug(
              og("script,style,head,html,body,title,meta,param"),
              A.getBlockElements()
            ));
          var m,
          ...
          t = md(
            {
              ...
              start: function (e, t, n) {
                ...
                if ((n = v ? A.getElementRule(e) : {})) {
                  ...
                  if ((f && C[e] && (f = !1), n.removeEmpty && Xm(A, g, C, d)))
                    return (
                      (i = d.parent),
            ...
            v &&
              ...
              (a.context
                ...
                : (function (e) {
                    ...
                    for (
                      d = og("tr,td,th,tbody,thead,tfoot,table"),
            ...
            for (d.body = 1, r = 0; r < f; r++)
              if (
                ...
                a === i &&
                  ...
                  (((l = new pf("#text", 3)).value = $r), o.replace(l));
              }
          }),
    ...
    lg = function (e, t, n) {
      return (function (e, t) {
        ...
        ? (function (e, t, n) {
            ...
            return (
              (t = t.cloneNode(!0)),
              (r = q.document.implementation).createHTMLDocument &&
  ...
  function vg(o) {
    ...
    function n(t, n) {
      U(o.undoManager.data, function (e) {
        "fragmented" === e.type
          ? (e.fragments = Y(e.fragments, function (e) {
              return i(e, t, n);
            }))
              ...
              t(function (e) {
                var t = Y(e, function (e, t) {
                  ...
                  return (
                    e.status && Cs(o)
                      ? u(n, e.url)
                      : e.error && dh.uploadError(o, e.error),
    ...
    var f,
      ...
      h = (function () {
        ...
        return {
          ...
          removeByUri: function (t) {
            n = j(n, function (e) {
              return (
                e.blobUri() !== t || (q.URL.revokeObjectURL(e.blobUri()), !1)
              );
            });
          },
          destroy: function () {
      ...
      g = [],
      p = function () {
        return (d = d || gg(m, h)).findAll(o.getBody(), s).then(
          t(function (e) {
            return (
              (e = j(e, function (e) {
  ...
  function xg(e, t, n, r) {
    ...
    return r
      ...
      : ((r = e.selection.getNode()),
        !!bg(e, r, t, n) ||
          !((o = e.selection.getStart()) === r || !bg(e, o, t, n)));
  }
  function zg(r, o, i) {
    var e,
      a = [],
    ...
    return (
      ...
      r.dom.getParent(
        ...
        function (e) {
          var t, n;
          for (t = 0; t < o.length; t++)
            (n = o[t]), !u[n] && ip(r, e, n, i) && ((u[n] = !0), a.push(n));
        },
        r.dom.getRoot()
      ),
      a
    ...
    return (
      t === r && en.isText(t)
        ? 0 < n &&
          ...
          ((t = (r = Ng(t, n)).previousSibling),
          n < o
            ? ((t = r = Ng(r, (o -= n)).previousSibling),
        ...
        : (en.isText(t) &&
          ...
          en.isText(r) &&
            0 < o &&
            o < r.nodeValue.length &&
            (o = (r = Ng(r, o).previousSibling).nodeValue.length)),
  ...
  function jg(e) {
    ...
    return (
      Xe(t, { id: dp, "data-mce-bogus": "1", "data-mce-type": "format-caret" }),
    ...
    if ("all" !== r.remove) {
      Hp(r.styles, function (e, t) {
        (e = vl(a, gl(e, o), t)),
          ...
          (!r.remove_similar && i && !Bp(yl(a, i, t), e)) ||
            a.setStyle(u, t, ""),
          (n = !0);
      }),
        n &&
    ...
    return "none" !== r.remove
      ? ((function (t, e, n) {
          ...
          n.block &&
            (a
              ? o === i.getRoot() &&
                ((n.list_block && Bp(e, n.list_block)) ||
                  Hp(Jn.grep(e.childNodes), function (e) {
              ...
              : i.isBlock(e) &&
                !i.isBlock(o) &&
                (wp(i, e, !1) ||
                  wp(i, e.firstChild, !0, !0) ||
                  e.insertBefore(i.create("br"), e.firstChild),
                wp(i, e, !0) ||
                  wp(i, e.lastChild, !1, !0) ||
  ...
  function zp(u, n, a, e, r) {
    function c(e) {
      var t = (function (n, e, r, o, i) {
        var a;
        return (
          Hp(Cl(n.dom, e.parentNode).reverse(), function (e) {
            var t;
            a ||
              "_start" === e.id ||
              "_end" === e.id ||
              ((t = ip(n, e, r, o, i)) && !1 !== t.split && (a = e));
          }),
          a
        );
      })(u, e, n, a, r);
    ...
    function t(e) {
      ...
      if (f.split) {
        if (((o = Sg(o)), (t = yp(u, o, !0)) !== (n = yp(u, o)))) {
          ...
          (t = bp(h, t, "span", { id: "_start", "data-mce-type": "bookmark" })),
            (n = bp(h, n, "span", { id: "_end", "data-mce-type": "bookmark" }));
          var a = h.createRng();
          a.setStartAfter(t),
            a.setEndBefore(n),
            nf(h, a, function (e) {
    ...
    var o,
      ...
      g = function (e) {
        ...
        if (
          ...
          for (n = 0, r = l.length; n < r && !xp(u, l[n], a, e, e); n++);
        if (f.deep && t.length) {
    ...
    if (e)
      ...
      for (
        var p = 0, v = l.length;
        p < v && (!l[p].ceFalseOverride || !xp(u, l[p], a, e, e));
        p++
      );
    }
  }
          ...
          Fp(d, function (e) {
            ...
            (!(1 < d.length) && c.isBlock(e)) || 0 !== n)
              ? (C.inline || C.wrapper) &&
                ...
                Mp(m, b, p, e),
                (function (t, n, r, o, i) {
                  (ip(t, i.parentNode, r, o) && xp(t, n, o, i)) ||
                ...
                (function (e, t, n, r) {
                  t.styles &&
                    ...
                    Lp(
                      r,
                      kp(e, "fontSize"),
                      Tp(e, "backgroundColor", gl(t.styles.backgroundColor, n))
                    );
                })(c, C, p, e),
                (function (e, t, n, r) {
                  t.styles &&
                    (t.styles.color || t.styles.textDecoration) &&
                    (Jn.walk(r, w(Ap, e), "childNodes"), Ap(e, r));
                })(c, C, 0, e),
                (function (e, t, n, r) {
                  ("sub" !== t.inline && "sup" !== t.inline) ||
                    (Lp(r, kp(e, "fontSize"), Tp(e, "fontSize", "")),
                    e.remove(
    ...
    var n,
      ...
      l = function (n, e, t) {
        ...
        return (
          ...
          t &&
            (r || (r = Kv.create("div")).appendChild(n),
    ...
    return "preview" in e && !1 === (u = e.preview)
      ...
      : ((t = e.block || e.inline || "span"),
        (r = (i = (function (e) {
          ...
          ? (i[0].name || (i[0].name = t), (t = e.selector), Wp(i, n))
          : Wp([t], n)),
        ...
        Kv.setStyles(r, { position: "absolute", left: -65535 }),
          ...
          if (
            !(
              ("background-color" === e &&
                ...
                ((t = Kv.getStyle(n.getBody(), e, !0)),
                "#ffffff" === Kv.toHex(t).toLowerCase())) ||
              ("color" === e && "#000000" === Kv.toHex(t).toLowerCase())
            )
          ) {
  ...
  function Yp(e, t, n, r, o) {
    var i = t.get(n);
    !xg(e, n, r, o) || ("toggle" in i[0] && !i[0].toggle)
      ? Up(e, n, r, o)
      : zp(e, n, r, o);
  }
  function Gp(e) {
      ...
      a = {
        ...
        add: function (e, t) {
          return (function (e, t, n, r, o, i, a) {
            var u = e.settings,
              c = ny(e);
            if (
              ((i = i || {}), (i = Jn.extend(i, c)), !1 === rv(r) || e.removed)
            )
              return null;
            var s = t.data[n.get()];
            if (
        ...
        undo: function () {
          return (function (e, t, n, r) {
            var o;
            return (
              t.typing && (t.add(), (t.typing = !1), ov(t, !1, n)),
              0 < r.get() &&
                (r.set(r.get() - 1),
                (o = t.data[r.get()]),
                ry(e, o, !0),
        ...
        hasUndo: function () {
          return (function (e, t, n) {
            return (
              0 < n.get() || (t.typing && t.data[0] && !oy(ny(e), t.data[0]))
            );
          })(n, a, i);
        },
        hasRedo: function () {
            ...
            if (!e.isDefaultPrevented())
              if ((33 <= t && t <= 36) || (37 <= t && t <= 40) || 45 === t)
                ...
                !(t < 16 || 20 < t) ||
                  ...
                  r.typing ||
                  n ||
                  (r.beforeChange(), ov(r, !0, o), r.add({}, e), a.set(!0));
              }
          }),
        ...
        if (
          ...
          var n = o.getBody(),
            r =
              !(function (e) {
                return (
                  uv(e) && !(cv(e) || ("keyup" === e.type && 229 === e.keyCode))
                );
              })(e) &&
              (function (e, t, n) {
          ...
          (("" !== i.getAttrib(n, ay)) === r && !t) ||
            (i.setAttrib(n, ay, r ? u : null),
    ...
    return e
      ? (function (e) {
          if (sy(e.previousSibling))
            return (
              gv(e.previousSibling) || e.previousSibling.appendData(gu.ZWSP),
              e.previousSibling
            );
      ...
      : (function (e) {
          if (sy(e.nextSibling))
            return (
              mv(e.nextSibling) || e.nextSibling.insertData(0, gu.ZWSP),
              e.nextSibling
            );
  ...
  function Dv(n, e, r, t, o, i) {
    return nu(my.findRootInline(e, r, t), my.findRootInline(e, r, o), function (
      e,
      t
    ) {
      return e !== t && my.hasSameParentBlock(r, e, t)
        ? py.after(n ? e : t)
        : i;
    }).getOr(i);
  }
  ...
  function Ov(e, t) {
    return e
      ? t.fold($(D.some, py.start), D.none, $(D.some, py.after), D.none)
      : t.fold(D.none, $(D.some, py.before), D.none, $(D.some, py.end));
  }
  function Hv(e, t, n, r) {
            ...
            !Vv(t) ||
              ...
              (function (e, t) {
                if (
                  ...
                  Ic.isTextPosition(n) &&
                    !1 === my.isAtZwsp(n) &&
                    (Lv(e, Jc.removeAndReposition(t.get(), n)), t.set(null));
                }
              })(t, n),
              (function (n, r, o, e) {
  ...
  function Ey(o, i, a, e, u, t) {
    function n(e) {
      var t, n, r;
      for (r = jv([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++)
        if (((n = r[t]), !a(n, c))) {
  ...
  function lb(e, t, n, r) {
    ...
    if (
      ...
      return null;
    if (((s = c.left), (u = My(a, s)) && Vw(u.node)))
      return (
        (l = Math.abs(s - u.left)),
        ...
        return ql.fromPosition(n, t, e.position()).bind(function (e) {
          return Hb(t, e).map(function (e) {
            return (function (t, n, r) {
              return en.isBr(r.position().getNode()) && !1 === sp(r.block())
                ? ql
  ...
  function Wb(e) {
    ...
    return $b(t, n)
      ...
      : (function (n, r) {
          var o = r.getRng();
          return nu(
            Xw(n, at.fromDom(o.startContainer)),
            Xw(n, at.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === ve(e, t) &&
                (o.deleteContents(),
  ...
  function Zb(e, t, n, r) {
    var o = r.getNode(!1 === t);
    return Xw(at.fromDom(e), at.fromDom(n.getNode()))
      .map(function (e) {
    ...
    return (function (e, t) {
      ...
      ? (function (e, t) {
          return e && en.isContentEditableFalse(t.nextSibling)
            ? D.some(rx.moveToElement(t.nextSibling))
            : !1 === e && en.isContentEditableFalse(t.previousSibling)
            ? D.some(rx.moveToElement(t.previousSibling))
            : D.none();
        ...
        function () {
          return (function (e, t, n) {
            var r = Dc(t ? 1 : -1, e, n),
              ...
              i = at.fromDom(e);
            return !1 === t && rb(o)
              ? D.some(rx.remove(o.getNode(!0)))
              : t && nb(o)
              ? D.some(rx.remove(o.getNode()))
              : !1 === t && nb(o) && Gb(i, o)
              ? tx(i, o).map(function (e) {
                  return rx.remove(e.getNode());
                })
              : t && rb(o) && Yb(i, o)
              ? nx(i, o).map(function (e) {
                  return rx.remove(e.getNode());
                })
              : Qb(e, t, o);
  ...
  function aC(n, r, o, i) {
    ...
    return c
      .bind(function (e) {
        return o
          ? e.fold(W(D.some(wy(e))), D.none, W(D.some(Cy(e))), D.none)
          : e.fold(D.none, W(D.some(Cy(e))), D.none, W(D.some(wy(e))));
      })
      .map(oC(n, r))
      .getOrThunk(function () {
  ...
  function bw(e, t) {
    return vw(t)
      ? Zy(t)
      : Zy(t) || ql.prevPosition(yw(e, t).dom(), t).exists(Zy);
  }
  function Cw(e, t) {
    return vw(t)
      ? Gy(t)
      : Gy(t) || ql.nextPosition(yw(e, t).dom(), t).exists(Gy);
  }
  function ww(e) {
    return Hc(e)
      .bind(function (e) {
  ...
  function Aw(t) {
    ...
    t.selection.isCollapsed() &&
      Tw(e, Ku.fromRangeStart(t.selection.getRng())).each(function (e) {
  ...
  function _w(e, t) {
    ...
    if (n)
      return "compositionstart" === t.type
        ? (t.preventDefault(), t.stopPropagation(), void Dw(e, n))
        : void (Ia(n) && (Dw(e, n), e.undoManager.add()));
  }
  function Ow(t) {
    !(function (e) {
      var t = da(function () {
  ...
  var Hw = w(ib, Ku.isAbove, -1),
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t, n) {
            ...
            Ww(
              [
                { keyCode: vh.RIGHT, action: db(e, !0) },
                { keyCode: vh.LEFT, action: db(e, !1) },
                { keyCode: vh.UP, action: hb(e, !1) },
                { keyCode: vh.DOWN, action: hb(e, !0) },
                { keyCode: vh.RIGHT, action: Eb(e, !0) },
                { keyCode: vh.LEFT, action: Eb(e, !1) },
                { keyCode: vh.UP, action: Nb(e, !1) },
                { keyCode: vh.DOWN, action: Nb(e, !0) },
                { keyCode: vh.RIGHT, action: zy.move(e, t, !0) },
                ...
                { keyCode: vh.UP, action: Db(e, !1) },
                { keyCode: vh.DOWN, action: Db(e, !0) },
              ],
              n
            ).each(function (e) {
              n.preventDefault();
    ...
    ax = function (e) {
      var t,
        n = ox(e.getBody(), e.selection.getNode());
      return (
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t, n) {
            Ww(
              [
                { keyCode: vh.BACKSPACE, action: $w(wx, e, !1) },
                { keyCode: vh.BACKSPACE, action: $w(ix, e, !1) },
                { keyCode: vh.DELETE, action: $w(ix, e, !0) },
                { keyCode: vh.BACKSPACE, action: $w(ux, e, !1) },
                { keyCode: vh.DELETE, action: $w(ux, e, !0) },
                { keyCode: vh.BACKSPACE, action: $w(cx, e, t, !1) },
                { keyCode: vh.DELETE, action: $w(cx, e, t, !0) },
                { keyCode: vh.BACKSPACE, action: $w(mx, e, !1) },
                { keyCode: vh.DELETE, action: $w(mx, e, !0) },
                { keyCode: vh.BACKSPACE, action: $w(gx, e, !1) },
                { keyCode: vh.DELETE, action: $w(gx, e, !0) },
                { keyCode: vh.BACKSPACE, action: $w(ex, e, !1) },
                { keyCode: vh.DELETE, action: $w(ex, e, !0) },
                { keyCode: vh.BACKSPACE, action: $w(Qw, e, !1) },
                { keyCode: vh.DELETE, action: $w(Qw, e, !0) },
                { keyCode: vh.BACKSPACE, action: $w(sx, e, !1) },
                { keyCode: vh.DELETE, action: $w(sx, e, !0) },
              ],
              n
            ).each(function (e) {
              n.preventDefault();
        ...
        t.on("keyup", function (e) {
          !1 === e.isDefaultPrevented() &&
            (function (e, t) {
              Ww(
                [
                  { keyCode: vh.BACKSPACE, action: $w(ax, e) },
                  { keyCode: vh.DELETE, action: $w(ax, e) },
                ],
                t
              );
            })(t, e);
        ...
        (u = XC(y, c)) &&
          ...
          /^(LI|DT|DD)$/.test(m) && y.isEmpty(s)
            ...
            : (p && s === a.getBody()) ||
              ((p = p || "P"),
              Pa(s)
                ? ((f = qa(s)), y.isEmpty(s) && qC(s), GC(a, f), zx(a, f))
                : n()
                ? r()
                : n(!0)
                ...
                : ((o = (function (e) {
                  ...
                  y.isEmpty(s) && qC(s),
                  f.normalize(),
                  y.isEmpty(f) ? (y.remove(f), r()) : (GC(a, f), zx(a, f))),
              y.setAttrib(f, "id", ""),
    ...
    Hx = function (e, t) {
      return gy(
        [
          gw([aw], Ox.none()),
          gw([sw("summary", !0)], Ox.br()),
          gw([lw(!0), fw(!1), hw], Ox.br()),
          gw([lw(!0), fw(!1)], Ox.block()),
          gw([lw(!0), fw(!0), hw], Ox.block()),
          gw([lw(!0), fw(!0)], Ox.br()),
          gw([cw(!0), hw], Ox.br()),
          gw([cw(!0)], Ox.block()),
          gw([uw(!0), hw, mw], Ox.block()),
          gw([uw(!0)], Ox.br()),
          gw([dw], Ox.br()),
          gw([uw(!1), hw], Ox.br()),
          gw([mw], Ox.block()),
    ...
    Ix = function (t) {
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            Ww([{ keyCode: vh.SPACEBAR, action: $w(Rw, e) }], t).each(function (
              e
            ) {
              t.preventDefault();
            });
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            Ww(
              [
                { keyCode: vh.END, action: mb(e, !0) },
                { keyCode: vh.HOME, action: mb(e, !1) },
              ],
              t
            ).each(function (e) {
              t.preventDefault();
    ...
    $x =
      ((Wx.prototype.nodeChanged = function (e) {
        var t,
          n,
          r,
    ...
    var v,
      ...
      c = function (e, t) {
        ...
        if (
          ...
          return null;
        if (
          (u === a + 1 && i === e.endContainer && (n = i.childNodes[a]), !Bz(n))
        )
          return null;
        if (
          ((l = f = n.cloneNode(!0)),
      ...
      Kn.ceFalse &&
        (function () {
          ...
          function i(e, t) {
            ...
            return (
              !(!n || !g.dom.isChildOf(n, r) || !1 !== Bz(tz(g, n))) ||
              (n &&
                !(function (e, t) {
                  return (
          ...
          (n = g).on(
            ...
            g.on("mousedown", function (e) {
              ...
              if (
                ...
                if ((t = tz(g, n)))
                  Bz(t)
                    ? (e.preventDefault(), c(Oy(g, t)))
                    : (s(),
                      (Hz(t) && e.shiftKey) ||
                        ph(e.clientX, e.clientY, g.selection.getRng()) ||
            ...
            g.on("keypress", function (e) {
              vh.modifierPressed(e) ||
                (e.keyCode, Bz(g.selection.getNode()) && e.preventDefault());
            }),
  ...
  function rz(a) {
    ...
    return (
        ...
        Kn.iOS
          ? (a.inline ||
              a.on("keydown", function () {
                q.document.activeElement === q.document.body &&
                  a.getWin().focus();
              }),
            r(),
            a.on("click", function (e) {
      ...
      h &&
        ...
        q.Range.prototype.getClientRects ||
  ...
  function iz(e, t) {
    ...
    var o = (function (e, t) {
      if (
        q.document.domain !== q.window.location.hostname &&
        Kn.browser.isIE()
      ) {
        var n = ep("mce");
        e[n] = function () {
  ...
  function Cz(e, t, n) {
    ...
    if (
      ...
      (r = e.parser),
      (h = n.merge),
      (o = Ef({ validate: e.settings.validate }, e.schema)),
      (d =
      ...
      p === v &&
        ...
        m.setRng(l)),
        m.isCollapsed() ||
          (e.selection.setRng(Ip(e.selection.getRng())),
      ...
      if (((u = r.parse(t, y)), !0 === n.paste && Wz(e.schema, u) && Xz(g, i)))
        return (
          (l = Kz(o, g, e.selection.getRng(), u)),
  ...
  var Az = function (e, t) {
          ...
          n.on("drop", function (e) {
            var t =
              "undefined" != typeof e.clientX
                ...
                : null;
            (Mz(t) || Mz(n.dom.getContentEditableParent(t))) &&
              e.preventDefault();
          });
        })(e);
    },
    Oz = function (t) {
      var e = da(function () {
        if (
          !t.removed &&
          t.getBody().contains(q.document.activeElement) &&
    ...
    Lz = function (t, e) {
      ...
      o.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.readonly ||
          (t.inline &&
            "static" === Pz.getStyle(n, "position", !0) &&
            ...
            e.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
              for (
                ...
                (t = e[n]).isEmpty(r) &&
                  ...
                  (t.append(new pf("br", 1)).shortEnded = !0);
            }),
            e
          );
        })(t)),
        ...
        o.browser_spellcheck ||
          o.gecko_spellcheck ||
          ((a.body.spellcheck = !1), Pz.setAttrib(n, "spellcheck", "false")),
        (t.quirks = rz(t)),
        (function (e) {
          e.fire("PostRender");
        })(t);
    ...
    Iz = function (e, t) {
      var n = iz(e, t);
      t.editorContainer &&
        ((Vz.get(t.editorContainer).style.display = e.orgDisplay),
    ...
    Uz = function (t, n, e) {
      ...
      if (((e = Jn.trim(e)), r && -1 === Jn.inArray(n, e))) {
        if (
          (Jn.each(rh.dependencies(e), function (e) {
            Uz(t, n, e);
          }),
          t.plugins[e])
        )
          ...
          if (X(t)) {
            ...
            (e.theme = new n(e, oh.urls[t])),
              e.theme.init &&
                e.theme.init(
                  e,
                  oh.urls[t] || e.documentBaseUrl.replace(/\/$/, ""),
                  e.$
                );
          } else e.theme = {};
        })(e),
        ...
        if (t.getElement() && Kn.contentEditable) {
          ...
          o &&
            ...
            e.hidden_input &&
              ...
              (qz.insertAfter(
                qz.create("input", { type: "hidden", name: n }),
                n
              ),
              (t.hasHiddenInput = !0)),
    ...
    rE = Jn.inArray,
    oE =
      ((iE.prototype.execCommand = function (t, n, r, e) {
        var o,
          i,
          a = !1,
          u = this;
        if (!u.editor.removed) {
          ...
          if (
            (tE(this.editor.plugins, function (e) {
      ...
      (iE.prototype.setupCommands = function (i) {
        ...
        this.addCommands({
          ...
          FontSize: function (e, t, n) {
            !(function (e, t) {
              e.formatter.toggle("fontsize", { value: kz(e, t) }),
                e.nodeChanged();
            })(i, n);
          },
  ...
  function pE(e, t) {
    return "selectionchange" === t
      ...
      ? (e.eventRoot || (e.eventRoot = EE.select(e.settings.event_root)[0]),
        e.eventRoot)
      : e.getBody();
  }
  function vE(e, t, n) {
  ...
  function yE(i, a) {
    ...
    if ((i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed))
      if (((e = pE(i, a)), i.settings.event_root)) {
        if (
          (wE ||
            ((wE = {}),
  ...
  var wE,
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(pE(n, e), e, n.delegates[e]),
    ...
    RE =
      ((DE.prototype.add = function (e, n, r, o) {
        var t,
          i = this;
        return (
          "string" == typeof (t = r)
      ...
      (DE.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return (
          ((o = Jn.map(TE(e, ">"), this.parseShortcut))[
            o.length - 1
        ...
        return (
          0 !==
            (o =
              (n = u.length - i) <= 0
                ? v(a).join("/")
                : u.slice(0, n).join("/") + "/" + v(a).join("/")).indexOf(
              "/"
            ) && (o = "/" + o),
    ...
    if (/^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)) r.source = e;
      ...
      if (
        ...
        var i = this.settings.base_uri
          ...
          : new VE(q.document.location.href).directory;
  ...
  var IE = ea.DOM,
    ...
    $E =
      ...
      (WE.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (IE.show(this.getContainer()), IE.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
        ...
        return (function (t, n) {
          return (
            ...
            D.from(t.getBody()).fold(
              W("tree" === n.format ? new pf("body", 11) : ""),
              function (e) {
                return xf(t, n, e);
              }
            )
      ...
      (WE.prototype.resetContent = function (e) {
        e === undefined
          ? Zf(this, this.startContent, { format: "raw" })
          : Zf(this, e),
      ...
      (WE.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = IE.get(this.id)), this.targetElm
        );
      }),
  ...
  function XE(e) {
    e !== rN &&
      (e
        ? Fi(window).on("resize scroll", KE)
        : Fi(window).off("resize scroll", KE),
      (rN = e));
  }
  function YE(t) {
    var e = iN;
    ...
    uN = ne(ne({}, xE), {
      ...
      setup: function () {
        ...
        if (r) (e = r.base || r.baseURL), (n = r.suffix);
          ...
          for (
            var o = q.document.getElementsByTagName("script"), i = 0;
            i < o.length;
            i++
          ) {
            var a;
          ...
          if (!e && q.document.currentScript)
            -1 !== (a = q.document.currentScript.src).indexOf(".min") &&
              (n = ".min"),
              (e = a.substring(0, a.lastIndexOf("/")));
        }
      ...
      init: function (r) {
        ...
        function s(e) {
          ...
          return (
            t ||
              ((t = (t = e.name) && !JE.get(t) ? e.name : JE.uniqueId()),
              e.setAttribute("id", t)),
            t
          );
        }
                    ...
                    case "exact":
                      0 < (e = t.elements || "").length &&
                        eN(QE(e), function (t) {
                          ...
                          (e = JE.get(t))
                            ? n.push(e)
                            : eN(q.document.forms, function (e) {
              ...
              r.types
                ? eN(r.types, function (t) {
                    Jn.each(o, function (e) {
                      return (
                        !JE.is(e, t.selector) || (n(s(e), tN({}, r, t), e), !1)
                      );
                    });
                  })
                : (Jn.each(o, function (e) {
        ...
        if (e) {
          if (!X(e))
            return (
              ...
              H(r.get(n.id))
                ? null
                : (YE(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === iN.length &&
  ...
  var fN,
    ...
    pN =
      ...
      (dN = {}),
      {
            ...
            var n = (function (e, t, n) {
              function r(n) {
                return function () {
                  ...
                  o ||
                    ((o = !0),
                    null !== i && (q.clearTimeout(i), (i = null)),
                    n.apply(null, e));
                };
              }
              void 0 === n && (n = 1e3);
        ...
        add: function (e, t) {
          dN[e] !== undefined && (dN[e](t), delete dN[e]),
            (fN[e] = xn.resolve(t));
        },
      }),
    vN = Math.min,
  ...
  lN.extend = hN = function (n) {
    ...
    (mN = !1),
    n.Mixins &&
      (xN(n.Mixins, function (e) {
        for (var t in e) "init" !== t && (n[t] = e[t]);
      }),
      u.Mixins && (n.Mixins = u.Mixins.concat(n.Mixins))),
    n.Methods &&
      xN(n.Methods.split(","), function (e) {
        n[e] = t;
      }),
    n.Properties &&
      xN(n.Properties.split(","), function (e) {
        var t = "_" + e;
        n[e] = function (e) {
    ...
    RN =
      ...
      (DN.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          void 0 === (e = kN.parse(e)) && (e = { error: "JSON Parse error." }),
            e.error
